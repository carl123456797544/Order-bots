const webhookURL = "https://discord.com/api/webhooks/1167746866662871061/dq12ht0uYo6ME5bDSj-CyjFbAvVUGNgi-dZ9eVXzNR7klCFWXdof7YUGD6DA4Mwn_4qM" // MANDATORY | Your Webhook URL Here
...
function sendMessage() { // After submitting the form.
    ...
    var params = { // Parameters to send the request
        username: `bots orders `, // Name of the webhook
    ...
    alert('Order Sent! Make Ticket and enjoy the bot!') // Tells the user that the appeal has been sent.
